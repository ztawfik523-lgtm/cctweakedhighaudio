...
| [ADR-0003](ADR-0003-additive-speakerperipheral-mixin.md) | Proposed | Add HighAudio Lua methods through a minimal additive Mixin into `SpeakerPeripheral`; accept only after EXP-001. |
