...
/** One Minecraft-owned source in the optional EXP-003 device-clock scheduled-start diagnostic. */
public final class Exp3ScheduledSound extends AbstractSoundInstance {
    private final long runToken;
    private final int index;
    private final Exp3SyncStream stream;

    public Exp3ScheduledSound(long runToken, int index, Vec3 position, Exp3SyncStream stream) {
